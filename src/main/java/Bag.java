...
public abstract class Bag {
    ...
    /**
     * Sets a new color to this bag.
     * @param color the color that this Bag is to be set to
     */
     ...
     * @return whether item could be successfully added
     */
     ...
     *
     * @return popped item, or null if Bag is empty
     */
